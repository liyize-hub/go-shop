...
type Activity struct {
	...
	Num           int        `json:"product_num" form:"product_num"`      //参与秒杀活动的商品优惠价格
	Name          string     `json:"name" form:"name" xorm:"varchar(32)"` //参与秒杀活动的商品名称
	OriginalPrice float64    `json:"price" form:"price"`                  //参与秒杀活动的商品原价
	Img           string     `json:"img" form:"img"`                      //参与秒杀活动的商品图片
